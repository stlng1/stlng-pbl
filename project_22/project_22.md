...
8. create git actions pipeline, *build_and_push_images.yaml* file in the workflows folder to create the docker image, and push to dockerhub
...
6. configuring s3 as repo for helm: 
